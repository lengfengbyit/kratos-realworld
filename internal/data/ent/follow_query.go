...
func (fq *FollowQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (fq *FollowQuery) FirstIDX(ctx context.Context) int64 {
...
func (fq *FollowQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (fq *FollowQuery) OnlyIDX(ctx context.Context) int64 {
...
func (fq *FollowQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (fq *FollowQuery) IDsX(ctx context.Context) []int64 {
	ids, err := fq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (fq *FollowQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(follow.Table, follow.Columns, sqlgraph.NewFieldSpec(follow.FieldID, field.TypeInt64))
	_spec.From = fq.sql
