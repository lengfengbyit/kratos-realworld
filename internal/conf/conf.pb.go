...
type Server_Auth struct {
	...
	Jwt *Server_Auth_JWT `protobuf:"bytes,1,opt,name=jwt,proto3" json:"jwt,omitempty"`
}
...
func (x *Server_Auth) GetJwt() *Server_Auth_JWT {
	if x != nil {
		return x.Jwt
	}
	return nil
...
func (x *Server_Auth_JWT) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_Auth_JWT) ProtoMessage() {}

func (x *Server_Auth_JWT) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_Auth_JWT.ProtoReflect.Descriptor instead.
func (*Server_Auth_JWT) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 2, 0}
}

func (x *Server_Auth_JWT) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
func (x *Server_Auth_JWT) GetExpires() string {
	if x != nil {
		return x.Expires
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xd5, 0x03, 0x0a,
	...
	0x63, 0x12, 0x2b, 0x0a, 0x04, 0x61, 0x75, 0x74, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x17, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x52, 0x04, 0x61, 0x75, 0x74, 0x68, 0x1a, 0x69,
	...
	0x65, 0x6f, 0x75, 0x74, 0x1a, 0x6e, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x2d, 0x0a, 0x03,
	...
	0x74, 0x68, 0x2e, 0x4a, 0x57, 0x54, 0x52, 0x03, 0x6a, 0x77, 0x74, 0x1a, 0x37, 0x0a, 0x03, 0x4a,
	0x57, 0x54, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x65, 0x78,
	0x70, 0x69, 0x72, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x65, 0x78, 0x70,
	0x69, 0x72, 0x65, 0x73, 0x22, 0xf3, 0x02, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a,
	...
	0x69, 0x73, 0x1a, 0x50, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x12, 0x16,
	...
	0x65, 0x62, 0x75, 0x67, 0x1a, 0xb3, 0x01, 0x0a, 0x05, 0x52, 0x65, 0x64, 0x69, 0x73, 0x12, 0x18,
	...
	0x69, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x25, 0x5a, 0x23, 0x6b, 0x72,
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Server_Auth_JWT)(nil),     // 6: kratos.api.Server.Auth.JWT
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	6,  // 9: kratos.api.Server.Auth.jwt:type_name -> kratos.api.Server.Auth.JWT
